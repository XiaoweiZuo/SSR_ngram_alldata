...
def one_data_point(data, word_index, class_dict, data_num, googlengram):
    ...
    ngram_dict, googlengram = ngram.ngram_selection(sentences, googlengram)  # ngram_dict is allowed
